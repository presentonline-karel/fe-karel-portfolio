      ...
      <Wrapper>
        ...
        <div className="w-full relative flex justify-between items-start">
          ...
          <div className="flex items-center gap-2">
            <div className="swiper-button-prev-highlightedProjects swiper-button cursor-pointer w-10 h-10 flex justify-center items-center border border-neutrals-1300 bg-neutrals-200 shadow-btnBlack">
              <FontAwesomeIcon icon={faArrowLeft} className="text-16 leading-4 w-4 h-4 text-neutrals-1300" />
            </div>

            <div className="swiper-button-next-highlightedProjects swiper-button cursor-pointer w-10 h-10 flex justify-center items-center border border-neutrals-1300 bg-neutrals-200 shadow-btnBlack">
