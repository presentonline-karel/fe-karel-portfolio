    ...
    <div className="pt-2">
      <div className="flex flex-col md:max-w-[842px] md:mx-auto">
        {data.content.blogunorderedlist.map((listItem: ListItemProps, index: number) => (
          ...
          >
            <FontAwesomeIcon icon={faChevronRight} className="text-14 leading-14px w-[8px] !h-[14px] text-prim-600 relative top-[3px] lg:!text-18 lg:!leading-26px lg:w-3 lg:!h-[26px] lg:top-0" />
